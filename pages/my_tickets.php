...
<div class="container mt-4">
    ...
    <ul class="nav nav-tabs mb-4">
        <li class="nav-item">
    <a class="nav-link text-warning <?= $tstatus == 'all' ? 'active' : '' ?>" 
       href="?tstatus=all&estatus=<?= $estatus ?>">Tất cả</a>
</li>
<li class="nav-item">
    <a class="nav-link text-warning <?= $tstatus == 'Thành công' ? 'active' : '' ?>" 
       href="?tstatus=Thành%20công&estatus=<?= $estatus ?>">Thành công</a>
</li>
<li class="nav-item">
    <a class="nav-link text-warning <?= $tstatus == 'Đã hủy' ? 'active' : '' ?>" 
       href="?tstatus=Đã%20hủy&estatus=<?= $estatus ?>">Đã hủy</a>
</li>
