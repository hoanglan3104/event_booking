    ...
    <div class="container">
        <div class="row align-items-center text-center text-lg-start">
            ...
            <div class="col-lg-4 mb-3 mb-lg-0">
                ...
                <p class="mt-2">© 2025 EventGate. All rights reserved.</p>
                <h6>Email</h6>
                <p><i class="bi bi-envelope"></i> support@eventgate.vn</p>
                <h6>Văn phòng</h6>
                <p><i class="bi bi-geo-alt-fill"></i> Tầng 3, 123 Đường Cầu Giấy, Phường Dịch Vọng, Quận Cầu Giấy, TP. Hà Nội</p>
            </div>
