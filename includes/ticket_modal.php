        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-md-5 d-flex align-items-center justify-content-center">
              <img src="../assets/images/confirm.png" alt="QR Code" class="img-fluid rounded" style="max-width: 280px;">
            </div>
          </div>
        </div>

        <div class="text-center mb-3">
          <button type="submit" class="btn" style="background-color: #5e777bff; color: white;">Xác nhận mua vé</button>
        </div>
