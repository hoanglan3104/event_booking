<div class="modal fade" id="loginModal" tabindex="-1">
    <div class="modal-dialog modal-sm"> 
        <div class="modal-content" style="min-height: 550px;"> 
            ...
            <div class="modal-header text-center position-relative" style="background-color: #5847a3ff; color: white; padding: 20px;">
            ...
            <div class="modal-body">
                <form action="../auth/login.php" method="POST">
                    ...
                    <button type="submit" class="btn w-100" style="background-color: #5847a3ff; color: white;">Tiếp tục</button>
                </form>
                ...
                <div class="text-center mt-2">
                    <span >Chưa có tài khoản? <a href="#" style="color: #5847a3ff" id="openRegister">Tạo tài khoản ngay</a></span>
                </div>
